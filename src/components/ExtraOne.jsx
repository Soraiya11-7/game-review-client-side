        ...
        <div className="py-10 bg-indigo-50 dark:bg-gray-700 my-10">
            <div className=" mx-auto text-center py-10 px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="flex flex-col items-center border border-violet-700  rounded-xl px-3 sm:px-6 py-8 bg-gray-400 shadow-lg">
                        ...
                        <p className="text-gray-700 mt-2 text-sm md:text-base w-[95%] sm:w-[80%] lg:w-[70%]">
                            Engage in exciting conversations about your favorite games.
                        </p>
                    </div>
                    <div className="flex flex-col items-center border border-violet-700  rounded-xl p-3 sm:p-6 bg-gray-400 shadow-lg">
                ...
                <div className="mt-8">
                    <button className="bg-violet-500 text-white px-6 py-3 rounded-xl text-lg font-bold">
                        Join Now
                    </button>
                </div>
            </div>
