...
const HighestRatedCard = ({reviews, setReviews}) => {
    ...
    return (
        <div className='dark:bg-slate-700 bg-gray-100'>
            ...
            <h3 className="mb-14 w-full sm:w-[80%] md:w-[60%] text-base md:text-lg mx-auto text-center">Discover the top-rated games that players love, showcasing only the best of the best!</h3>
